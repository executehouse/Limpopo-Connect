        ...
        <div className="text-center">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-lg text-gray-500 mb-12">
              Join relaxed gatherings and social events in your community. Perfect for 
              low-pressure socializing and meeting new people in comfortable settings.
            </p>
            
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">What's Coming:</h3>
              <ul className="text-left space-y-2 text-gray-600">
                <li>• Coffee meetup organization</li>
                <li>• Local gathering spots</li>
                <li>• Spontaneous event creation</li>
                <li>• Group size preferences</li>
                <li>• Casual activity suggestions</li>
              </ul>
            </div>
