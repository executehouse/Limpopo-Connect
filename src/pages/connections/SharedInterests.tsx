        ...
        <div className="text-center">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-lg text-gray-500 mb-12">
              Bond over common passions, hobbies, and interests. From photography to cooking, 
              gardening to gaming, find your tribe based on what you love most.
            </p>
            
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">What's Coming:</h3>
              <ul className="text-left space-y-2 text-gray-600">
                <li>• Interest-based community groups</li>
                <li>• Skill sharing and learning</li>
                <li>• Hobby project collaboration</li>
                <li>• Interest discovery tools</li>
                <li>• Passion project matchmaking</li>
              </ul>
            </div>
